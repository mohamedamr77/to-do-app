      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(6),
           color:
           (
               Theme.of(context).canvasColor==Colors.black &&widget.taskModel.doneTask==true?ColorApp.primaryColor
                   :
               Theme.of(context).canvasColor==Colors.black&&widget.taskModel.doneTask==false? ColorApp.whiteColor
                   :
               Theme.of(context).canvasColor==Colors.white&&widget.taskModel.doneTask==true? const Color(0xff90B6E2)
                   :
        ...
        child:  Text(
          ...
          style: TextStyle(
            color:
                 ...
                 */
            (Theme.of(context).canvasColor==Colors.black &&widget.taskModel.doneTask==true?Colors.white:
            Theme.of(context).canvasColor==Colors.black&&widget.taskModel.doneTask==false? const Color(0xff739CCB):
            Theme.of(context).canvasColor==Colors.white&&widget.taskModel.doneTask==true? const Color(0xff24364B) :
